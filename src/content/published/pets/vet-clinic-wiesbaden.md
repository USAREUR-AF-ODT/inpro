...
The on-post Veterinary Treatment Facility (VTF) provides primary veterinary care for pets registered to SOFA-status personnel. It's not a full-service hospital and **does not handle emergencies**. For anything urgent or surgical, you go to a civilian Tierklinik in Wiesbaden or Frankfurt.

All pets living on-post **must register** with the VTF within 30 days of arrival. This is garrison policy, not just a suggestion.

## Where

**Bldg 1038, Wurger St., Clay Kaserne.** Park at the visitor lot adjacent to the building. CAC required for base entry.
...
Make appointments; walk-ins accepted if time permits, but appointments preferred.
...
### Pet registration for on-post residency
This is mandatory. Bring:
- Original health certificate used for import (or vaccination record)
- Rabies certificate
- Microchip paperwork
- SOFA card

### Prescription refills
**Lead time: 72 hours.** Call ahead; don't wait for your pet to run out. Pickup at the VTF front desk.
...
### For routine / non-emergency primary care (if you live off-post)

Many Wiesbaden vets welcome US military. Tips for finding one:
- **Ask other Soldiers/Families** in the neighborhood via the USAG Wiesbaden Facebook group
...
**TRICARE does not cover pets.** Out-of-pocket for everything.
...
- **Fighting breed muzzle + leash** required always in public

### Dog waste
- **Poop pickup is the law.** Fines up to €100 for not picking up.

### Kampfhunde (fighting breeds)
See the Pet Import entry for the full list and requirements. If you own one, Hessen requires extra paperwork.

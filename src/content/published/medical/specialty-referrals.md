...
summary: "Your ARHC PCM refers through ATLAS; TRICARE Overseas approves; you book. 2-5 days for routine, same-day for urgent. English-speaking specialists are plentiful in Wiesbaden — ATLAS has a searchable directory."
topic: medical
phase: settle
usag: wiesbaden
profile_tags:
...
sources:
  - {tier: T1, url: "https://www.tricare-overseas.com/en/home", label: "International SOS — TRICARE Overseas"}
...
You need a specialist: dermatologist, OB/GYN, orthopedist, mental health, whatever. The Wiesbaden Army Health Clinic (ARHC) doesn't have every specialty in-house. For anything specialized, you need a referral to a German civilian specialist through the TRICARE Overseas ATLAS network.

The process looks scarier than it is. Here's how to make it work.
...
- Have signed terms-of-service agreements
- Usually have English-speaking staff (signified in the directory)
- Accept TRICARE patients as a routine matter
...
- OB/GYN: 4-8 weeks; complex 3+ months
- Orthopedics: 2-4 weeks; surgery consult 4-6 weeks
- Dermatology and gynecology have the longest waits in Wiesbaden

### Pushback tactics if the wait is too long
- Ask if you can be on the cancellation list
- Try sister offices or competing practices
- Some specialists have "Privatpatient" slots (private patients); TRICARE patients can sometimes use these
- Go to Frankfurt for faster access (40 min train)

## When to bypass ATLAS

### Emergency
Dial 112 or go to the nearest hospital ER. No referral needed. Notify TRICARE Overseas within 24 hours to initiate reimbursement.
...
### TRICARE Overseas ATLAS directory
...
### On-post options
Wiesbaden Army Health Clinic has some behavioral health capacity, limited waitlist.

### Embedded Behavioral Health (within units)
...
ARHC's pediatrics team refers to:
- **HSK Pediatrics**
...
1. Pregnancy confirmed at ARHC
2. Referral to ATLAS OB/GYN (Wiesbaden-area private practice or HSK)
3. German pattern: obstetrician + *Hebamme* (midwife) + hospital delivery
4. Delivery at HSK or Asklepios
5. Discharge typically faster than US pattern (2-3 days for uncomplicated delivery)
6. TRICARE covers; co-pays minimal

Many families PCS to Wiesbaden *intending* to have a child here. It's a positive experience.

## Reimbursement if you paid out-of-pocket

1. Collect: receipts, provider info, referral documentation
2. Submit online via tricare-overseas.com claim portal OR mail to TRICARE Overseas
3. Expect 4-6 weeks for initial processing
4. Keep all originals until check clears

## Gotchas

- **Referral before appointment, not after.** Going to a specialist first and seeking referral after is a reimbursement trap.
- **German medical records aren't in English** usually. Ask for English summaries from specialists for ARHC coordination.
- **Some US-specific meds aren't available in Germany.** Specialists prescribe German equivalents. Substitution is usually fine; confirm with your US pharmacist if transitioning.
...
Process synthesized from International SOS (the TRICARE Overseas contractor) and MilitaryOneSource Wiesbaden's health-care page. Specific providers and wait times change quarterly; always confirm via ATLAS or TRICARE Overseas before committing.

...
- Current orders reflected
- SOFA status confirmed
- Mailing address change queued
- Emergency data updated
- Awards / schools / qualifications confirmed
...
If your POV has arrived, schedule DES registration. If not, register when it lands.
...
- Uniform: usually OCPs; confirm with sponsor
...
- **Awards**: decoration submissions
- **Tour length**: extensions, curtailments
- **Command sponsorship**: family arrival approvals
- **Leave / pass**: all leave actions
...
If you have family:
- Introduce yourself to the FRG leader (spouse volunteer) in your first 2 weeks
- FRG covers Family-side communications: events, resources, crisis support
- Separate from Command Family Readiness (Active Duty communication)
- Attending the first FRG meeting within 30 days is a good signal
...
Contractor in-processing is unit-specific and depends on:
- Your contracting company's onboarding
- Your client command's access requirements
- Base access (DBIDS via Visitor Control Center if no CAC)
...
Every unit handles in-processing slightly differently:
...
Ask your sponsor 48 hours before arrival what your specific unit expects. Each is a flavor of the same process.

## Language conventions

- **S1**: Personnel/Admin (HR)
- **S2**: Intelligence / Security
- **S3**: Operations / Training
- **S4**: Logistics / Supply
- **S6**: Communications / Signal / IT
- **PAC**: Personnel Action Center (enlisted side of S1)
- **HHC**: Headquarters & Headquarters Company
- **NCOIC**: Non-Commissioned Officer In Charge (your go-to senior NCO)
- **DET**: Detachment
- **PLT**: Platoon
...
Synthesized from the OIG Wiesbaden Inprocessing Brief, the USAG Wiesbaden in-processing page, and community knowledge of first-week unit procedures. Unit-specific variations are significant; always defer to your gaining S1's specific guidance over this general framework.

...
### 1. Verify it's actually silence
Before escalating, confirm:

- **You have the right email.** Enterprise mail addresses change; check the Army White Pages.
- **Your emails aren't in their spam folder.** Try a different email if you have one, and check if yours has a bounce notice.
- **You've given reasonable time.** 48 hours isn't silence during a duty week. 2 weeks is.
- **It's not a major holiday window.** Christmas/New Year and German summer break (late July/early August) collapse response times. Factor in.

### 2. Call the sponsor once
If email fails, one phone call is reasonable. Leave a voicemail: "This is [name], I'm PCSing to your unit arriving [date]. Please call me back at [number]." Then stop calling. More than one unanswered call feels like pressure and most sponsors respond to guilt by going deeper into silence.

### 3. Contact the gaining unit S1
Short, factual email to the S1:

> I was assigned [Rank Name] as my sponsor on [date]. I've emailed and called but not received a response in [X] weeks. My RNLTD is [date]. Requesting either a sponsor reassignment or a status update. Thank you.

Don't frame this as a complaint. Frame it as an operational gap you need the S1 to close. Most S1s will reassign within 48 hours when asked this way.

### 4. Loop ACS Relocation Readiness
In parallel, email or call **USAG Wiesbaden ACS Relocation Readiness**. Summary:
...
This is not a revenge move. It's a system-level signal that prevents the next Family from the same experience.

### 6. Prepare for self-service arrival
Regardless of sponsor status, you can complete a functional arrival:
...
## Who to ask the "stupid" questions

Without a sponsor, route by topic:

- **Housing** → Housing Services Office (HSO)
- **Medical** → ARHC Wiesbaden front desk or PCM assignment
- **Schools** → School Liaison Office (SLO)
- **Finance** → DFAS, unit S1, or ACS Financial Readiness
- **Pets** → ACS or the Wiesbaden veterinary treatment facility
- **German bureaucracy** → ACS Relocation or the Anmeldung appointment at the Bürgeramt
- **Legal questions** → USAG Wiesbaden Legal Office
- **General Wiesbaden life** → FRG, unit spouse group, Wiesbaden Facebook groups

These offices won't be warm and fuzzy like a good sponsor, but they all work.

## Gotchas

- **Don't try to reassign a sponsor after arrival** unless the first one was actively harmful. You're already at the unit; the social cost of rejecting someone formally is higher than the reward.

...
You have one carry-on bag and a personal item for the 7-8 hour flight to Germany + 6-12 weeks until your HHG arrives. Pack like that.

Assumptions:
- HHG ships separately; you won't see it for 4-12 weeks
- UB ships separately; you'll see it in 2-3 weeks
- Commercial / Patriot Express weight limits apply (typically 2 checked bags + carry-on + personal item per person)
- You're checking bags for clothing + bulk items

## Document carry-on (non-negotiable)
...
- [ ] **90-day supply** of chronic medications (back-up for the first month)
- [ ] **Doctor's letter** for any controlled substances (US-style prescriptions don't automatically translate to EU protocols)
...
Pack in carry-on in case bags delay:
- Underwear, socks
- One comfortable layer (sweatshirt / fleece)
- Basic hygiene kit (travel-size)

## Kids specifically

For each child:
- [ ] **Comfort item** (lovey, blanket, small stuffed animal)
...
- [ ] **Nothing in glass jars** (potential leak + weight)

## Adapter + power strategy

Your phone charger has USB → USB-C/Lightning + brick. The brick goes into a Type F adapter → German outlet. Your phone charges fine.

**Pack 3-5 Type F adapters**. You'll want them distributed:
- 1 for personal item / carry-on
...
### Heavy books / souvenirs
- Save weight for essentials; ship books via HHG.

### Liquids over 100ml (3.4 oz)
- Airport security takes them; wasted space

### Anything electronic that needs TSA screening
- Tablets, laptops must come out at US security. Pack them in easily-removable slots.

## Per-person weight limits
...
FRA (Frankfurt) arrival:
- **Passport control**: fast for military
- **Customs**: declare pets; food items (for kids) usually fine
- **Luggage claim**: long carousel; your bags may be last
- **Exit**: S-Bahn train to Wiesbaden (40 min, €5), or taxi (€70-90), or rental car

Ramstein (Patriot Express) arrival:
- **Shuttle or rental** to Wiesbaden (90 min drive north)
...
Opinion + community knowledge. Specific airline limits change; verify your carrier's current policy before packing. PCS travel regs in the Joint Travel Regulations detail DoD-side packing allowances.

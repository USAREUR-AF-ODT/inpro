...
The 90-day pre-PCS checklist. Companion to [The First-Month Checklist](/entries/id-cac/first-month-checklist) covering post-arrival. Start at 90 days out; by the time you have 30 days left, most items should be completed or in motion.
...
→ See: [POV Shipping](/entries/vehicle/pov-shipping)
...
→ See: [TRICARE Overseas](/entries/medical/tricare-overseas)
...
→ See: [Banking Options](/entries/finance/banking-options)
...
→ See: [110V vs 220V Electronics](/entries/life/electricity-110-220)
...
### EFMP
- [ ] **Update EFMP if changes** (new diagnosis, new provider, changed accommodations)
- [ ] **Email EFMP summary** to ACS liaison at Wiesbaden (DSN 548-9201 ext EFMP)

→ See: [EFMP Enrollment](/entries/family/efmp-enrollment)
...
### POV
- [ ] **Drop off car at losing VPC** (if not yet)
- [ ] **Rental car secured** for US-side post-drop
- [ ] **Rental car / rental lodging** for German-arrival
...
### Legal
- [ ] **Will updated** at losing Legal Office
- [ ] **POA** for trusted person (US-based) for post-PCS logistics
...
- [ ] **Passports + orders + dependent IDs** in carry-on, backup photocopies
- [ ] **Bring pet paperwork** (original health certificate)
- [ ] **Laptop + chargers + one 220V adapter** in carry-on
...
- **Delaying EFMP update**: screens slow down; don't start at 90 days
- **Assuming TRICARE auto-transfers**: it doesn't; request the transfer
- **Missing pet health-cert window**: 10 days before EU entry, not more
- **Packing 110V electronics you don't need**: they won't work
- **Not prepping pet for cargo travel**: stressed pet is unhappy pet
- **Over-shipping furniture you don't need**: measure your German space before buying/shipping big items
- **Forgetting the passport renewal**: US passport needs 6+ month validity past PCS end date
...
Compiled from MilitaryOneSource Wiesbaden relocation guidance, the Wiesbaden in-processing page, and community experience of 100+ PCS-to-Wiesbaden moves. Unit-specific pre-PCS requirements vary; always confirm with gaining S1. A PCS has many small parts; this is the master checklist, not every detail.

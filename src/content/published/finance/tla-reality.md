...
Off-post temporary hotels can exceed the cap, especially during Oktoberfest or other high-demand periods. You eat the overage.

### Meals & incidental component (M&IE)
Per-diem M&IE. Current Wiesbaden rate around $79/day for the first arrival day, full rate thereafter, reduced rate when you've moved into permanent quarters but are still waiting on HHG.

The M&IE rate steps down:
- Days 1-30: 100% of per diem
- Days 31-60: 75%
- Extension beyond 60: requires special authorization

A family of four in Wiesbaden on full TLA runs about **$250-$320/day** combined (lodging + M&IE), of which most flows through the Lodge directly and the meals portion hits your pay 1-2 cycles later.
...
Army Lodge is usually the right choice. Off-post makes sense if:
- Lodge is full
- You're a family with 3+ kids and Lodge rooms are too tight
- You need pet-friendly (some Lodge rooms are pet-friendly, but limited)
- You're close to signing a lease and the neighborhood hotel lets you commute-test

...
- **DFAS** operates SDP; enrollment happens through your unit S1 or finance office
- **Finance Office** at USAG Wiesbaden (DHR) can walk soldiers through enrollment pre-deployment
- **MyPay** (mypay.dfas.mil) shows your SDP balance and transaction history once enrolled
- **JUMPS** (legacy DFAS system) is behind the scenes; most soldiers never see it directly

## When

- **Eligibility window**: you must be in a **Combat Zone Tax Exclusion (CZTE)** zone for **30+ consecutive days**
- **Enrollment**: typically during pre-deployment finance in-processing, but can be done in theater
- **Deposits**: start after the 30th consecutive day in theater; continue monthly through deployment
- **Interest accrual**: begins on first deposit; compounds semiannually
- **Interest continues**: for **up to 90 days after** you return from the deployment
- **Withdrawal**: within 90 days of return; after that, no further interest; funds remain accessible
...
### 1. Qualifying zone
SDP requires deployment to a location designated as a **Combat Zone Tax Exclusion (CZTE)** zone, **Qualified Hazardous Duty Area (QHDA)**, or certain **Contingency Operations**. Current list of zones is on the DFAS page; common active zones rotate with operational deployments.

**Wiesbaden itself is not a qualifying zone.** You must be deployed from Wiesbaden to a qualifying location to enroll. Many Wiesbaden-based units rotate soldiers forward to qualifying theaters; talk to your unit S1 to confirm your deployment qualifies.

### 2. Enrollment
Done via your unit. Paperwork routes to DFAS. Account creates in the SDP system; you see the balance on MyPay.

### 3. Deposits
- **Maximum deposit per month**: your **unallotted base pay** (i.e., pay not already going to other allotments)
- **Maximum total balance**: **$10,000**
- **Deposit mechanism**: typically via direct transfer from your DFAS pay, one time or monthly
- **Lump sum vs. monthly**: both allowed; many soldiers transfer a lump-sum early in deployment to maximize interest time

**Tactical note**: deploy with existing US savings ready to move into SDP quickly. The more time your money sits at 10%, the more you earn.
...
### 5. Withdrawal
- **Automatic notification** at 90 days post-deployment: DFAS will start to disburse if you haven't initiated withdrawal
- **Interest continues** for up to 90 days after you return; after that, balance stops earning
- **You can leave money in SDP briefly** during the 90-day post-deployment grace if you're planning a specific use for it (house down payment, car purchase)
- **Withdrawal mechanism**: DFAS initiates direct deposit to your registered account

## What SDP is and isn't good for
...
### Day 1 home
- Confirm SDP balance on MyPay
- Start the 90-day clock for remaining interest

### 30 days home
- Decide: withdraw now or let ride for the 90-day grace period earning more interest

### 60 days home
- Withdrawal typically initiated; funds land in your bank account

### 90 days home
- Final deadline; DFAS auto-disburses if you haven't initiated

### Tax year after deployment
- 1099-INT from DFAS shows interest earned
- Report on federal tax return
- CZTE exclusion applies to earnings during in-zone months; verify with a tax preparer who does military returns

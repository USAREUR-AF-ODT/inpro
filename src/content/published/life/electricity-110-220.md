...
2. **110V only**: needs a step-down transformer OR a 220V replacement.
3. **High-draw 110V**: don't bother with transformers. Replace.
...
## Things that typically work with just a plug adapter

- **Laptops** (all modern ones)
- **Smartphone chargers** (USB wall warts)
- **Tablets**
- **Camera battery chargers**
- **Gaming consoles** (modern ones; check label)
- **Kindle / e-readers**
- **Most electric razors / shavers** (the modern ones)
- **Electric toothbrushes** (usually)
- **Most modern TVs** (dual-voltage)

**Plug adapter needed**: Type E or F (round pins, typical EU socket). Get a 3-pack at dm, Amazon.de, or bring from CONUS.
...
For these: **replace with 220V German versions.** Step-down transformers for high-draw items (1500W+) are expensive ($200+), bulky, and often unreliable. Not worth it.

## What US appliances are actually worth shipping

- **Computer monitors** (check dual voltage; most are)
- **Stereo systems** (only if component is dual-voltage)
- **Gaming consoles** (PS5/Xbox are dual-voltage)
- **TVs** (modern ones are dual-voltage)
- **Kitchen appliances with dual-voltage designation** (rare)
...
**When transformers actually make sense**:
- Single irreplaceable US appliance (vintage audio, specific medical device)
- Motor-based items that need clean 110V (some sewing machines, woodworking tools)
- Built-in-wall CONUS devices

For everything else: replace with German versions.

## Frequency difference (50Hz vs 60Hz)

Most modern electronics don't care. Problems arise in:
- **Clock-radios** (run slow)
- **Synchronous motors** (run slow, then burn out)
- **Some timer-based devices**
- **High-end audio** (pitch and pickup issues with turntables)

...
- Powers of Attorney (general, medical, financial, limited)
...
**Not included**:
- Criminal defense (you hire a German lawyer or receive one via the UCMJ process)
- German-law matters (traffic tickets, landlord-tenant court cases, criminal)
- Representation in non-US courts
- Estates of significant size (beyond will-prep and some estate-admin advice)
- Tax preparation outside VITA season
- Business/corporate law

## Where

**Legal Office, Clay Kaserne.** Contact USAG DHR for current building location; phone routing via **DSN 548-9107** or garrison main.
...
### Will
- Basic wills (simple estate, no trusts): same-day appointment possible
- Complex wills (trusts, business interests, international assets): require multi-appointment process
- **Bring**: list of beneficiaries, specific bequests, guardian designations for minors
- **Update before PCS**: if your life circumstances changed (marriage, child, spouse death), update the will

### Power of Attorney
- **General POA**: broad authority for a single person to act on your behalf
- **Limited POA**: specific authority (e.g., "my spouse can sign the lease" or "my parent can act on my car loan in CONUS")
- **Medical POA** / **Advance Directive**: for medical decisions if incapacitated
- **POA specific to DEERS / ID card**: DD Form 1172-2, common
- **POA for minor dependents**: single-parent operational needs

**Expiration**: Some POAs auto-expire (DD-1172-2 typically 1 year). Check before relying on an old one.

### Notarial services
- Sworn statements, affidavits
- Acknowledgments on US legal documents
- Translated-document certification (limited; German Stadt usually needs a certified translator)

Free for Active Duty + dependents; ~$20 for some civilians.

### Home of Record and Legal Residency
Two distinct concepts that people confuse:
- **Home of Record (HoR)**: the state where you entered military service; affects tax withholding and voting for Active Duty
- **State of Legal Residence (SLR)**: the state you consider home for tax purposes; may differ from HoR
- **German resident**: Anmeldung makes you a German resident for local-services purposes but SOFA shields most tax impact

Changes to HoR/SLR require specific paperwork and intent (bank account, driver's license, voting registration in the new state).

### Divorce overseas (difficult)
The USAG Wiesbaden Legal Office advises on US-jurisdiction divorce (your state of legal residence). You cannot be divorced in Germany under SOFA status without specific German-court involvement.
...
### Loss-in-Quarters claims
If government housing (on-post quarters) or your off-post RPP lease suffers damage from facility issues (burst pipe, electrical fire), the Legal Office helps you file for compensation.

**Bring**: lease or housing document, photos of damage, timeline of events, any quotes from repair/replacement providers.

## When to hire a German lawyer instead

- Criminal charges (DUI, traffic offenses prosecuted criminally, etc.)
- Being sued in German civil court
- Landlord-tenant disputes headed to court (Wiesbaden Amtsgericht)

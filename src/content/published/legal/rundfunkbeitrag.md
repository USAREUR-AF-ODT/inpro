...
- **Ignoring letters is the most expensive choice.** Beitragsservice escalates: reminder → formal notice → *Mahnbescheid* (formal legal notice) → collections → potential wage garnishment through your German employer (irrelevant for SOFA-exempt but still a paper nightmare).
- **The fee is per dwelling, not per person.** A family of 6 pays one €18.36. A single in a shared flat pays one if nobody else has registered that apartment.
- **Your name on the lease matters.** If your apartment came registered under a prior tenant, Beitragsservice may already have a file on that dwelling. Anmelden triggers review.
- **Multiple dwellings** (main residence + second home or vacation apartment): each dwelling owes separately. Exemption applies only to the main residence if you're SOFA status.
- **SOFA exemption is not forever.** Tied to your orders; when you PCS out, the exemption ends. Do the Abmeldung properly so the account closes.
- **Your German landlord may advise you to just pay.** They mean well; they don't know about SOFA. Trust the USAG Legal Office guidance instead.
- **Don't skip Anmeldung to avoid Rundfunkbeitrag.** You'll create bigger problems (Kindergeld, Kita, driver's-license conversion, German tax) for a €18.36/month issue that's solvable through the exemption.
- **Keep copies of everything.** Exemption letters, Abmeldung receipts, Bescheide. If a post-PCS claim arrives 18 months later, you need the paper trail.
- **Mailing address errors** are common. Beitragsservice uses the address on your Anmeldung; if that's slightly wrong (fehlende Hausnummer, etc.), letters bounce and the account escalates without you knowing.

## Source notes

Rate, form structure, and exemption grounds drawn from the Beitragsservice portal (verified 2026-04-20). SOFA treaty text is the authoritative source on exemption eligibility; the USAG Legal Office is the local expert for edge cases.

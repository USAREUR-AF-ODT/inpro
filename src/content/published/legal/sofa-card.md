...
summary: "NATO SOFA status exempts you from German income tax, vehicle tax, and import duties. The SOFA stamp (Certificate of Entry) goes in your passport at the Passport/Visa Office within 90 days of arrival."
topic: legal
phase: arrive
usag: wiesbaden
profile_tags:
...
sources:
  - {tier: T1, url: "https://home.army.mil/wiesbaden/about/Garrison/directorate-human-resources/passportvisa", label: "USAG Wiesbaden — Passport/Visa Office"}
...
The stamp goes in your passport within **90 days** of arrival. You'll need it visible or at least accessible for most official interactions off-post.
...
Applications for all dependents in the household can usually be processed in a single appointment. Bring everyone or their passports.

## What the stamp does for you

### Tax exemption
SOFA-status personnel:
- **No German income tax** on your DoD-source salary (Soldier pay, DA Civ pay, contractor pay structured correctly)
- **No church tax (Kirchensteuer)** automatically exempted
...
- **DA Civilians**: work is authorized by your USAJobs appointment
- **Family members**: SOFA status alone does NOT grant work permission. To work on the German economy, Family members need a separate work permit (*Arbeitserlaubnis*) obtained through Stadt Wiesbaden's Foreigners Office (*Ausländerbehörde*). Exceptions exist for US-only employers (Army jobs on-post, US company telework).
...
### Vehicle privileges
- USAREUR plate registration via DES
- Exempt from German Kfz-Steuer
- Must still meet German safety inspection standards (similar to TÜV requirements)

## SOFA card vs. SOFA stamp vs. Certificate of Entry

Three terms, same thing (usually):
- **SOFA card**: older term, sometimes the plastic ID issued by some commands
- **SOFA stamp**: the actual stamp in your passport
- **Certificate of Entry**: the official name of the stamp

In Wiesbaden, what you get is the passport stamp. Carry it whenever you're off-post.

## When you need to show it

- Traffic stops by German Polizei
- Crossing Schengen borders (usually your passport alone is enough, but the stamp resolves questions)
...
- **Renewal**: if your tour extends, your passport stamp may be renewed at the same office. Bring updated orders.
- **PCS-out**: no specific de-stamping. The stamp becomes inactive when your orders end. Your passport continues to work as a US travel document.
- **Passport renewal mid-tour**: new passport = new SOFA stamp. Coordinate renewal of the US passport through the Passport/Visa Office (they process US State Department passport renewals on-post).

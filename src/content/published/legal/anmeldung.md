...
**Living off-post**: you Anmelden. This isn't optional, even for Soldiers.

## Why it matters

Without Anmeldung you cannot:
- Open a traditional German bank account (online-only banks often work around this)
- Sign many utility, internet, or mobile-phone contracts
- Register your POV at German tax office (if ever needed)
- Get a German tax ID, which matters for German-side income (spouse job, etc.)
- Register with Rundfunkbeitrag (which happens automatically once Anmeldung triggers)

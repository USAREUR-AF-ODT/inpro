...
See [Army Community Service](/entries/family/army-community-service) for the broader ACS overview and [How to be a good sponsor](/entries/family/being-a-good-sponsor) for PCS-related family support.
...
- Legal readiness: POAs, wills, DEERS, SGLI, beneficiary updates
- Financial readiness: joint accounts, budget changes on deployment, pay allotments
- Communication: phone cards, AT&T CONUS call plans, mail to theater, OPSEC
- Family resources: FRG structure, chain of concern, emergency contacts
...
### Legal readiness (via USAG Legal Office)
Free POA drafting, will updates, DEERS verification for family members. The USAG Legal Office is a separate shop but coordinates closely with ACS during the pre-deployment window.

## Programs during deployment

### Hearts Apart
**Kids-focused events** for children with a deployed parent. Monthly-ish activities: craft nights, bowling events, pool parties, movie days. Free; pre-registration through ACS.

### Family support groups
Peer-led groups for spouses of deployed soldiers. Wednesday evenings at ACS (typical; check schedule). Topics range from "getting through the first 30 days" to practical logistics (child care during TDY-on-top-of-deployment).

### Financial check-ins
ACS Financial Readiness runs 1-on-1 sessions: deployment pay differences, combat pay, Savings Deposit Program (SDP at 10% guaranteed interest on up to $10k), tax implications, debt management during the deployment.
...
For deployed Reserve and Guard soldiers, Yellow Ribbon runs pre-/during-/post-deployment events. Less relevant for Active Duty at Wiesbaden but ACS helps connect any affected families.

### Post-deployment counseling (MFLC and Behavioral Health)
First 90 days after return are the highest-risk window. ACS actively follows up with families who went through pre-deployment briefings. Use them; this is what ACS exists for.

### Strong Bonds post-deployment
...
Program structure and deployment-cycle services from the USAG Wiesbaden ACS page and Army MWR Family Programs (verified 2026-04-20). Specific program calendars and FRG structures change by unit and deployment cycle; the ACS front desk is authoritative for current offerings.

...
- Which German TV remote works in the Lodge room?
- Which grocery store has food the kids will actually eat?
- How does the airport train from FRA work, for real?
- Is the Housing Office window on Tuesday really closed for walk-ins?
...
Email or call with:
- Introduction (who you are, rank, position, family if relevant)
- Confirmation of their orders and expected arrival date
- **Basic logistics they'll need**: sponsor phone, Army Lodge reservation status, airport pickup plan
- Photos or video call if they have kids (helps kids see a friendly face before landing)

### Reality-check their expectations
- Most new arrivals underestimate Wiesbaden's cost-of-living and overestimate how much house they'll get
...
- **Rental car**: do they need one from FRA? Arrange if yes
- **Sponsor's own calendar**: block the arrival days; you should be reachable
- **On-post orientation schedule**: note upcoming newcomer briefings (3rd Tuesday at ACS)
- **Unit-specific asks**: is there formal paperwork (DD 1610, DD 1172-2) they need in hand?
...
- The direct garrison shuttle schedule printed on paper
- A paper map of Clay Kaserne + Hainerberg
- Key contacts: ACS, HSO, Finance, your unit S1
- A list of the nearest things: grocery store, hair salon, restaurant you actually like

## Week 1

### Check in daily (phone / text is fine)
- Are they sleeping?
- Have they found food they like?
- Is their first appointment at HSO on the calendar?

### Help with the logistics they didn't expect
- **German power adapters / 220V equipment**: remind them to plug nothing US-110V into German 220V
- **Cell phone SIM**: walk them through the SIM card purchase at dm / Lidl
- **Grocery strategy**: commissary vs. German store, and which they should use for what
- **Banking setup**: open the German bank together if you've done it yourself

### What you don't do
- Don't make decisions for them. They're adults; you're a guide.
...
### You're assigned to someone you can't realistically help
- Rank gap (you're an E-8 assigned to a junior enlisted who doesn't know how to approach you)
- Family situation mismatch (you're single, they have 4 kids)
- **Tell your unit S1 promptly** if the assignment seems mismatched; they can re-route to a better fit
- Don't suffer silently; bad sponsorship is worse than no sponsorship

### You overcommit and underdeliver
- Don't promise airport pickup if your schedule can't reliably hold
- Don't say "I'll help you find a house" if you can't actually help (that's HSO's job anyway)
- Be specific about what you can do and what you can't

### They ghost you
- Some newcomers don't engage. Send a weekly check-in for 3 weeks; after that, close the loop and note it for your S1

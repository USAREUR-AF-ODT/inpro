...
Wiesbaden High School (WHS) and Wiesbaden Middle School (WMS) field DoDEA-Europe athletic teams that travel by bus or charter flight across Germany, Italy, the UK, and Belgium. The varsity circuit runs three seasons (fall, winter, spring) with conference games and a European championship. Beyond sports, WHS carries a strong JROTC battalion (Warrior Battalion), music (band, chorus), drama, robotics, academic teams (Math Counts, JSHS, Model UN), yearbook, student government, and honor societies.

For many teenagers, extracurriculars are the thing that turns a Wiesbaden tour from "two years of homework in a foreign country" into a memorable chapter.
...
- **Travel permission** for away games
- **Medical-release form**

All on-hand from the school in pre-season packets.

### 4. Fees
DoDEA absorbs most travel costs for varsity athletes; Families may be asked to cover:
- **Uniforms** (some sports)
- **Spirit wear and optional team apparel**
...
- **Injuries overseas**: sports injuries get ARHC treatment with off-post specialty referral as needed. Concussion protocol is strict (mandated rest and graduated return-to-play).
- **Extracurriculars are first-come for popular clubs**: robotics, drama, and music often cap membership. Sign up the first week of school.
- **JROTC drill and raider teams** compete heavily; tryouts within the unit are selective.

## Source notes

Season structure, sport offerings, and general eligibility drawn from the Wiesbaden High School and Wiesbaden Middle School DoDEA sites and the DoDEA Wiesbaden Community Schools portal (verified 2026-04-20). Specific coach names, rosters, and annual championship hosts change yearly; the school websites and pre-season newsletters are authoritative for the current year.
